...
function resolverBaza() {
    ...
    jugadores.forEach(j => {
        j.haGanadoBaza = PAREJA[j.asiento] === pareja;
        j.haCantadoEstaBaza = false;
    });
...
function mostrarResultado() {
    ...
    d.innerHTML = `
        ...
        Pareja 0: ${puntosPareja[0] + puntosCanticos[0]}<br>
        Pareja 1: ${puntosPareja[1] + puntosCanticos[1]}
    `;
}
